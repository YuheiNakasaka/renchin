  ...
  class Client
    ...
    def movie_to_gif(input, output, options={})
      ...
      if opts[:quality] == 'low'
        ...
        o1, e1, i1 = Open3.capture3("#{command_path}ffmpeg -i #{movie_file} -vf scale=w=256:h=256:force_original_aspect_ratio=decrease -f image2 renchin_movie_to_gif_frame_%05d.png")
